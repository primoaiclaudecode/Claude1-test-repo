...
@section('content')
	...
	<section class="panel">
		...
		<section class="dataTables-padding">
			...
			{!! Form::open(['url' => 'reports/sales-summary/grid', 'class' => 'form-horizontal form-bordered', 'id' => 'cash_sales_form']) !!}
			<div class="form-group">
				<label class="col-xs-4 col-sm-3 control-label custom-labels">Unit Name:</label>
				<div class="col-xs-8 col-sm-4">
					{!! Form::select('unit_id', $userUnits, $selectedUnit, ['id' => 'unit_id', 'class'=>'form-control', 'placeholder' => 'All', 'tabindex' => 1, 'autofocus']) !!}
			...
			<div class="btn-toolbar">
				<input type='submit' id="submit_btn" class="btn btn-primary btn-md" name='submit' value='Get Report' tabindex='33'/>
				<input type='button' id="cancel_btn" class="btn btn-primary btn-md" name='cancel' value='Cancel' tabindex='34' onclick="window.location='{{ $backUrl }}'" />
			</div>
			{!!Form::close()!!}
		</section>
	</section>
