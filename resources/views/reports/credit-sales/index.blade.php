...
<section class="panel">
    <header class="panel-heading">
        <strong>Credit Sales Report</strong>
    </header>
    ...
    <section class="dataTables-padding">
        ...
        {!! Form::open(['url' => 'reports/credit-sales/grid', 'class' => 'form-horizontal form-bordered', 'id' => 'credit_sales_form']) !!}
            ...
            <div class="btn-toolbar">
                ...
                <input type='submit' id="submit_btn" class="btn btn-primary btn-md" name='submit' value='Get Report' tabindex='24' />
                <input type='button' id="cancel_btn" class="btn btn-primary btn-md" name='cancel' value='Cancel' tabindex='25' onclick="window.location='{{ $backUrl }}'" />
            </div>
        {!!Form::close()!!}
    </section>
</section>
