...
@section('content')
	<section class="panel">
		<header class="panel-heading">
			<strong>Client Feedback Report</strong>
		</header>
		...
		<section class="dataTables-padding">
			...
			{!! Form::open(['url' => 'reports/client-feedback/grid', 'class' => 'form-horizontal form-bordered', 'id' => 'client_feedback_form']) !!}
			<div class="form-group">
				<label class="col-xs-4 col-sm-3 control-label custom-labels">Unit Name:</label>
				<div class="col-xs-8 col-sm-4">
					{!! Form::select('unit_id', $userUnits->toArray(), $selectedUnit, ['id' => 'unit_id', 'class'=>'form-control', 'placeholder' => 'Select Unit Name', 'tabindex' => 1, 'autofocus']) !!}
