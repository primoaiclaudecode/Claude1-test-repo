...
@section('content')
    <section class="panel" id="purchases-report">
            ...
            <div class="responsive-content">
                <table class="table simpleTable table-hover table-bordered table-striped margin-bottom-0 table-small">
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" name="contract_status" id="contract_status" value="{{ $contractStatus }}"
        ...
        <section class="dataTables-padding">
            <div class="responsive-content">
                <table id="report_data" class="display nowrap full-width table-small" cellspacing="0">
                    <thead>
                    <tr>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var oTable = $('#report_data').DataTable({
                ...
                "columnDefs": [
                    {targets: [0, 3], className: "text-align-center"},
                    {width: "200px", targets: [0, 1, 3]},
                ],
                buttons: [
                    {
                        extend: 'excelHtml5',
