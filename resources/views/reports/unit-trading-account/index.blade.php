            ...
            <div class="responsive-content">
                <table class="table simpleTable table-hover table-bordered table-striped margin-bottom-0 table-small">
                    ...
                    <tr>
                        ...
                        <td><INPUT id="trading_days_pro_rata" type="text" class="text-right form-control" value="{{$trading_days_pro_rata}}"
                    ...
                    <tr>
                        ...
                        <td><INPUT id="weeks_pro_rata" type="text" class="text-right form-control" value="{{$weeks_pro_rata}}" readonly="readonly"/>
                        </td>
                    </tr>
                    </tbody>
                </table>
