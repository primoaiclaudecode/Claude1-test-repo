...
@section('content')
  	<section class="panel">
		...
		<section class="dataTables-padding">
            ...
            {!! Form::open(['url' => 'reports/problem-report/grid', 'class' => 'form-horizontal form-bordered', 'id' => 'problem-report_form']) !!}
            ...
            <div class="form-group">
                ...
                <div class="col-xs-8 col-sm-4">
                    {!! Form::select('unit_name', $userUnits, $selectedUnit, ['id' => 'unit_name', 'class'=>'form-control', 'placeholder' => 'All', 'tabindex' => 3]) !!}
                    <span id="unit_name_span" class="error_message"></span>
                </div>
   			</div>

            <div class="form-group">
                <label class="col-xs-4 col-sm-3 control-label custom-labels">Category:</label>
                <div class="col-xs-8 col-sm-4">
                    {!! Form::select('problem_type',['0' => 'All'] + $problemTypes->pluck('title', 'id')->toArray(), $selectedProblemType, ['id' => 'problem_type', 'class'=>'form-control', 'placeholder' => 'All', 'tabindex' => 4]) !!}
                    <span id="unit_name_span" class="error_message"></span>
                </div>
            </div>
