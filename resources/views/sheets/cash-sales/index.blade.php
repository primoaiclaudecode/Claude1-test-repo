		...
		<section class="dataTables-padding">
            ...
            <div class="form-group margin-bottom-0">
                <div class="table-responsive margin-top-10 col-md-6 div_sales_total hidden_element padding-left-0 padding-right-0">
                    <table class="table">
                        <tr>
                            <td class="border-top-0 padding-0"><h2>Sales Total</h2></td>
            ...
            <div class="form-group set-margin-left-0 set-margin-right-0">
                ...
                <input type='submit' id="submit_btn" class="btn btn-primary btn-block button margin-top-25" name='submit' value='Add Sales' tabindex='22' />
            </div>
   			{!!Form::close()!!}
       	</section>
  	</section>
        ...
        function regNumberCashPurchasesCreditSales() {
            ...
            if(unitNameVal != 0) {
                $.ajax({
                    ...
                    data: { unit_name: unitNameVal, sheet_id: sheet_id, selected_reg_number: '{{ $selectedRegNumber }}' }
                }).done(function( data ) {
