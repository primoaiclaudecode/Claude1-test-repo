        ...
        <section class="dataTables-padding">
            ...
            <div class="form-group">
                ...
                <div class="col-xs-12 col-lg-8 hidden_element change_log_div">
                    ...
                    <div class="collapse" id="change-log-collapse">
                        <table id="change_log_table" class="table simpleTable table-hover table-bordered table-striped margin-bottom-0"></table>
                    </div>
                </div>
            </div>
            ...
            <div class="responsive-content">
                <table id="trading_account_tbl" class="table-medium full-width">
                    ...
                    <tr>
                        ...
                        <td>
                            <input class="form-control" type="hidden" name="head_count_totals" id="head_count_month_1" value="0"/>
                        </td>
                        <td>
                    ...
                    <tr id="total_row" class="">
                        <td>Total</td>
                        <td>
                            <input class="form-control" type="text" value="0" name="budget_total_totals" id="budget_total_totals" readonly="readonly"/>
                        </td>
                        <td>
