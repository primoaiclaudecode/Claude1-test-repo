		...
		<section class="dataTables-padding">
            ...
            <div class="form-group">
                ...
                <div class="col-xs-12 col-sm-7 col-lg-3">
                    {!! Form::select('unit_name', $userUnits, $selectedUnit, ['id' => 'unit_name', 'class'=>'form-control margin-bottom-15', 'placeholder' => 'Select Unit', 'tabindex' => 1, 'autofocus', 'onchange' => 'previousStock(this.value)']) !!}
            ...
            <div class="form-group set-margin-left-0 set-margin-right-0">
                ...
                <input type='submit' id="submit_btn" class="btn btn-primary btn-block button margin-top-35" name='submit' value='Submit' tabindex='11' />
            </div>
   			{!!Form::close()!!}
       	</section>
  	</section>
