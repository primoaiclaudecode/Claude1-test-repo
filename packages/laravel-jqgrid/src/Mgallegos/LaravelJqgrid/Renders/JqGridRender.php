	...
	*/
	...
	public function renderGrid($script = true, $createTableElement = true, $createPagerElement = true, $echo = true)
	{
		...
		$html .= '<form method="' . $this->options['mtype'] . '" action="'. $this->options['url'] . '" accept-charset="UTF-8" id="'. $this->gridId .'ExportForm">
								...
								<input name="unit_id" type="hidden" value="' . @$this->options['unit_id'] . '">
								<input name="from_date" type="hidden" value="' . @$this->options['from_date'] . '">
								<input name="to_date" type="hidden" value="' . @$this->options['to_date'] . '">
								<input name="all_records" type="hidden" value="' . @$this->options['all_records'] . '">
								<input name="sheet_id" type="hidden" value="' . @$this->options['sheet_id'] . '">
