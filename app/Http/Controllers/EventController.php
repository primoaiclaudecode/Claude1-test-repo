	...
	public function index()
	{
		...
		foreach ($activeUsers as $activeUser) {
			$activeUsersList[] = [
				...
				'updatedAt' => $activeUser->updated_at ? Carbon::parse($activeUser->updated_at)->format('d-m-Y H:i') : '',
				'expiredAt' => $activeUser->expired_at ? Carbon::parse($activeUser->expired_at)->format('d-m-Y H:i') : '',
			];
		}
