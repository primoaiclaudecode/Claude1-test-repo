...
use App\Http\Controllers\PurchasesDataUtils;
...
class ReportController extends Controller
{
    ...
    public function purchasesGridJson(Request $request)
    {
        ...
        return PurchasesDataUtils::GetPurchasesDataTables($purchases);
    }
    ...
    public function creditSalesGridJson(Request $request)
    {
        ...
        if (Gate::allows('su-user-group')) {
            $dataTable = Datatables::of($creditSales)
                ...
                {
                    return $creditSale->vat_total * $creditSale->exchange_rate;
                })
                ->editColumn('gross_total', function ($creditSale)
                {
                    return $creditSale->gross_total * $creditSale->exchange_rate;
                })
    ...
    public function purchasesSummaryGrid(Request $request)
    {
        ...
        $nominalCodes = PurchasesDataUtils::GetNominalCodesForSummary($fromDate, $toDate, $unitIDStr, $purchaseTypeStr);
        ...
        $table = PurchasesDataUtils::GetPurchasesSummaryTable($purchases, $nominalCodesArr, $currencySymbol);
